...
var ratingReport = "<h1>Customer Reviews</h1><h2>" + ratingsAvg + "out of 5 stars (" + ratingsCount + " reviews";

for(var i = 0; i < 3; i++){
   ratingReport += "div class='review'><h1>" + ratingTitles[i] + "</h1><table><tr><th>By</th>" + ratingAuthors[i] + "</td></tr><tr><th>Review Date</th><td>" + ratingDates[i] + "</td></tr><tr><th>Rating</th><td>";
   // Question 12b
   for(i = 0; i < ratings[i]; i++){
